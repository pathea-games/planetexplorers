...
namespace RedGrass
{
	public class RGPrototypeMgr : MonoBehaviour
	{
		...
		[SerializeField] public List<RGPrototype> m_Prototypes;
...
//	   		System.IO.File.WriteAllBytes("Assets/Scripts/ZhouXun/Grass Billboards/Textures/" + m_DiffuseMapFileName + ".png", pixels);
			System.IO.File.WriteAllBytes("Assets/RedGrass/Textures/" + m_DiffuseMapFileName + ".png", pixels);
...
//	   		System.IO.File.WriteAllBytes("Assets/Scripts/ZhouXun/Grass Billboards/Textures/" + m_PropertyMapFileName + ".png", pixels);
			System.IO.File.WriteAllBytes("Assets/RedGrass/Textures/" + m_PropertyMapFileName + ".png", pixels);
		}
	}
}
