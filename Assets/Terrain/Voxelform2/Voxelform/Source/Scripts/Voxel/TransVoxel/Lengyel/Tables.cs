...
namespace Transvoxel.Lengyel
{
	...
	public static class Tables
	{
		...
		// In C version, RegularCellData's vertexIndex has length of 15 which is 36 in TransitionCellData
		// In CSharp version these 2 struct have been merged into struct RegularCell
		public struct RegularCell
		{
			...
			{
				get{	return vertexIndex[idx];	}
			}
		};

		public static readonly IntVector3[] RegularCornerCoords = {
		...
		// voxel pos(indexing as described in Figure4.16)
        public static readonly IntVector3[] TransitionCornerCoords = {
                new IntVector3(0,0,0), new IntVector3(1,0,0), new IntVector3(2,0,0), // High-res lower row
                new IntVector3(0,1,0), new IntVector3(1,1,0), new IntVector3(2,1,0), // High-res middle row
                new IntVector3(0,2,0), new IntVector3(1,2,0), new IntVector3(2,2,0), // High-res upper row
                new IntVector3(0,0,2), new IntVector3(2,0,2), // Low-res lower row
                new IntVector3(0,2,2), new IntVector3(2,2,2)  // Low-res upper row
        };
		public static readonly IntVector3[] TransitionFaceDir = {
			new IntVector3( 0, 0,-1),	// face to nz, fron
			new IntVector3(-1, 0, 0),	// face to nx, left
			new IntVector3( 0, 0, 1),	// face to pz, back
			new IntVector3( 1, 0, 0),	// face to px, righ
			new IntVector3( 0, 1, 0),	// face to py, up
			new IntVector3( 0,-1, 0),	// face to ny, down
		};
		public static readonly IntVector3[,] TransitionFaceCoords = {
			// x axis					y axis						z axis					origin coord			axisIndex extend,mesh width
			{new IntVector3( 1, 0, 0), new IntVector3( 0, 1, 0), new IntVector3( 0, 0, 1), new IntVector3( 0, 0, 0), new IntVector3( 2,-1, 0)},	// face to nz, front
			{new IntVector3( 0, 0,-1), new IntVector3( 0, 1, 0), new IntVector3( 1, 0, 0), new IntVector3( 0, 0, 1), new IntVector3( 0,-1, 0)},	// face to nx, left
			{new IntVector3(-1, 0, 0), new IntVector3( 0, 1, 0), new IntVector3( 0, 0,-1), new IntVector3( 1, 0, 1), new IntVector3( 2, 1, 0)},	// face to pz, back
			{new IntVector3( 0, 0, 1), new IntVector3( 0, 1, 0), new IntVector3(-1, 0, 0), new IntVector3( 1, 0, 0), new IntVector3( 0, 1, 0)},	// face to px, right
			{new IntVector3( 1, 0, 0), new IntVector3( 0, 0, 1), new IntVector3( 0,-1, 0), new IntVector3( 0, 1, 0), new IntVector3( 1, 1, 0)},	// face to py, up
			{new IntVector3( 1, 0, 0), new IntVector3( 0, 0,-1), new IntVector3( 0, 1, 0), new IntVector3( 0, 0, 1), new IntVector3( 1,-1, 0)},	// face to ny, down
		};
		
		#region ModifiedMC_Regular
		...
		// which a case can be mapped by the regularCellClass table.(HiNibble:VertexCount;LoNibble:TriangleCount)
		...
		// We combined those classes for this table so that the class index ranges from 0 to 55(0x37).
		...
		// (HiNibble:VertexCount; LoNibble:TriangleCount)
		...
		// shown in Figure 4.18.-->4.19
		//The high nibble contains a direction code for which the bit values 1 and 2
		//correspond to a subtraction in the local x and y directions, and the low nibble specifies one of the
		//storage slots shown in Figures 4.18(a) and 4.18(b).
		...
		// in Figure 4.16. order:little,big; such as 36,9b
		// The high byte contains the vertex reuse data (edge code) shown in Figure 4.18
