		...
		public override Var Calculate ()
		{
			...
			if (!a.isNull && !b.isNull)
			{
				...
				else if (a.type == EVarType.Vector && b.type == EVarType.Vector)
				{
					...
					c = (float)(retval.x + retval.y + retval.z + retval.w);
				}
				...
				{
					Vector4 retval;
					retval.x = a.value_c.r * b.value_c.r;
					retval.y = a.value_c.g * b.value_c.g;
					retval.z = a.value_c.b * b.value_c.b;
					retval.w = a.value_c.a * b.value_c.a;
					c = (float)(retval.x + retval.y + retval.z + retval.w);
				}
			}
