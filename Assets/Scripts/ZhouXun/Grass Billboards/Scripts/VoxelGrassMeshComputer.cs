...
public static class VoxelGrassMeshComputer
{
	...
	/// --------- [!!! Obsolete !!!] ---------
	/// </summary>
	public static int ComputeMesh (List<VoxelGrassInstance> grass_list, int offset, MeshFilter mf_inout, float density)
	{
	...
	/// --------- [!!! Obsolete !!!] ---------
	/// </summary>
	public static int ComputeMesh (List<VoxelGrassInstance> grass_list, int offset, float density)
	{
		return grass_list.Count;
	}
}
