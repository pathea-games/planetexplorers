...
public class WStandardShaderGUI : ShaderGUI
{
	...
	private static class Styles
	{
		...
		public static GUIContent albedoMaskText = new GUIContent("AlbedoMask", "Mask (RGB) (0 or 1)");
	...
	MaterialProperty albedoSkinColor = null;
	MaterialProperty albedoSkinCoef = null;
	MaterialProperty alphaCutoff = null;
	MaterialProperty albedoMask = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
		...
		albedoSkinColor = FindProperty ("_SkinColor", props);
		albedoSkinCoef = FindProperty ("_SkinCoef", props);
		alphaCutoff = FindProperty ("_Cutoff", props);
		albedoMask = FindProperty("_MaskTex", props);
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			m_MaterialEditor.TexturePropertySingleLine(Styles.albedoMaskText, albedoMask, albedoSkinColor, albedoSkinCoef);
